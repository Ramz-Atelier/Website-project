      ...
      <section class="section container">
        ...
        <div class="education-section reveal">
          ...
          <div class="education-timeline">
            ...
            <div class="edu-card">
              <div class="edu-icon-wrap edu-icon-degree">
                <i data-lucide="award" style="width: 22px; height: 22px;"></i>
              </div>
              <div class="edu-content">
                <span class="edu-label">Bachelor's Degree</span>
                <h4 class="edu-title">Bachelor of Engineering in Computer Science</h4>
                <p class="edu-institution"><i data-lucide="building-2" style="width: 14px; height: 14px;"></i> Sri Venkateswara College of Engineering and Technology – Thiruvallur</p>
                <span class="edu-year"><i data-lucide="calendar" style="width: 14px; height: 14px;"></i> Year of Completion: 2014</span>
              </div>
            </div>

            <div class="edu-card">
              <div class="edu-icon-wrap edu-icon-hsc">
                <i data-lucide="book-open" style="width: 22px; height: 22px;"></i>
              </div>
              <div class="edu-content">
                <span class="edu-label">Higher Secondary</span>
                <h4 class="edu-title">Higher Secondary Certificate (HSC - Class 12 - Computer Science)</h4>
                <p class="edu-institution"><i data-lucide="building-2" style="width: 14px; height: 14px;"></i> Doveton Corrie Boys Higher Secondary School, Chennai, Tamil Nadu</p>
                <span class="edu-year"><i data-lucide="calendar" style="width: 14px; height: 14px;"></i> Year of Completion: 2010</span>
              </div>
            </div>

            <div class="edu-card">
              <div class="edu-icon-wrap edu-icon-sslc">
                <i data-lucide="school" style="width: 22px; height: 22px;"></i>
              </div>
              <div class="edu-content">
                <span class="edu-label">Secondary School</span>
                <h4 class="edu-title">Secondary School Leaving Certificate (SSLC - Class 10)</h4>
                <p class="edu-institution"><i data-lucide="building-2" style="width: 14px; height: 14px;"></i> Doveton Corrie Boys Higher Secondary School, Chennai, Tamil Nadu</p>
                <span class="edu-year"><i data-lucide="calendar" style="width: 14px; height: 14px;"></i> Year of Completion: 2008</span>
              </div>
            </div>
        ...
        <!-- Certifications -->
        <div class="certifications-subsection reveal">
          <h3 class="education-heading">
