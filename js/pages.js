...
function renderHome() {
  ...
  return `
    <section class="dashboard-hero page-enter" id="hero-section">
      ...
      <div class="container hero-showcase-container relative-z" style="display: flex; position: relative; justify-content: flex-end; padding: 40px 0;">
        
        <!-- Floating Profile Card Overlay (Left/Top) -->
        <div class="floating-profile-card reveal-left active" style="z-index: 30; position: absolute; left: 0; top: 15%;">
        ...
        <div class="macbook-mockup reveal-up" style="position: relative; z-index: 10; width: 85%; max-width: 900px;">
          <div class="macbook-screen scroll-float-app">
            <div class="macbook-camera"></div>
            <div class="app-window" style="width: 100%; height: 100%; max-width: none; border: none; border-radius: 4px; box-shadow: none; transform: none; transition: none;">
