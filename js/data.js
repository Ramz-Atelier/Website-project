...
const CERTIFICATIONS = [
  ...
  },
  {
    ...
    date: 'Jan 2022',
    credentialId: 'CSM-555444',
    category: 'Project Management',
    skills: ['Scrum Framework', 'Facilitation', 'Agile Coaching'],
    icon: 'users',
    verifyUrl: '#'
  },
  {
    ...
    date: 'Nov 2023',
    credentialId: 'GDA-ABCDEFG',
    category: 'Data Analytics',
    skills: ['SQL', 'R Programming', 'Tableau', 'Data Cleaning'],
    icon: 'bar-chart-3',
    verifyUrl: '#'
  },
  {
    ...
    date: 'Feb 2024',
    credentialId: 'MS-PL300-888',
    category: 'Data Analytics',
    skills: ['DAX', 'Data Modeling', 'Power Query', 'Data Visualization'],
    icon: 'pie-chart',
    verifyUrl: '#'
  },
  {
    ...
    organization: 'IASSC',
    date: 'Sep 2021',
    credentialId: 'LSSGB-777666',
    category: 'Process Improvement',
    skills: ['DMAIC', 'Root Cause Analysis', 'Process Mapping', 'Statistical Analysis'],
    icon: 'target',
    verifyUrl: '#'
  },
  {
  ...
  },
  {
    ...
    date: 'Mar 2025',
    credentialId: 'IBM-AI-999',
    category: 'AI',
    skills: ['Machine Learning Basics', 'Generative AI', 'AI Strategy', 'Ethics'],
    icon: 'brain',
    verifyUrl: '#'
  },
  {
    ...
    organization: 'AXELOS',
    date: 'Jul 2024',
    credentialId: 'ITIL-444555',
    category: 'Process Improvement',
    skills: ['IT Service Management', 'Service Value System', 'Continual Improvement'],
    icon: 'server',
    verifyUrl: '#'
  },
  {
    ...
    organization: 'Google (Coursera)',
    date: 'Dec 2023',
    credentialId: 'GPM-XYZ123',
    category: 'Project Management',
    skills: ['Project Planning', 'Risk Management', 'Agile Project Management'],
...
const INSIGHTS = [
  {
    id: 'insight-1',
    title: "It'll only take 5 minutes",
    date: 'July 21, 2026',
    category: 'Operations',
    ...
    icon: 'clipboard-check',
    thumbnail: 'assets/images/only 5 mins.png'
  },

{
    ...
    icon: 'clipboard-check',
    thumbnail: 'assets/images/meeting without action.png'
  },
{
    id: 'insight-3',
    ...
    icon: 'clipboard-check',
    thumbnail: 'assets/images/27 emails.png'
  },
{
    id: 'insight-4',
    ...
    excerpt: 'Nobody talks about this enough... 🗣️Being productive isn't about finishing everything...',
    readTime: '1 min read',
    ...
    icon: 'clipboard-check',
    thumbnail: 'assets/images/Firefly_Gemini Flash_Professional.png'
  },  
  {
    id: 'insight-5',
